...
class LanguageModel {
    ...
    /**
     * Word-level bigram language model for correcting entire homophenes.
     */
    private val wordBigramMap: Map<String, Map<String, Double>> = mapOf(
    ...
    fun getWordScore(prevWord: String, currentWord: String): Double {
        val nextMap = wordBigramMap[prevWord.lowercase()] ?: return UNIFORM_PROB
